...
public class rangedAttack_Dragon : StateMachineBehaviour {
	GameObject player;
	void Awake()
	{
	...
	override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex) {
		animator.GetComponent<RangedAttack_Dragon>().enabled = true;
	...
	override public void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex) {
		animator.GetComponent<RangedAttack_Dragon>().enabled = false;
